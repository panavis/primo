...
public class CaseBodyParserTests {
    ...
    @Test
    public void comm_court_nyarugenge_2014_secondSubsectionOfBodyHasExpectedHeading() {
    ...
    @Test
    public void comm_court_nyarugenge_2014_secondSubsectionHasExpectedLength() {
        JsonObject secondSubsection = getCaseBodySubsection(4, 1);
    ...
    @Test
    public void comm_court_nyarugenge_2014_secondSubsectionMatchesExpectedContent() {
        JsonObject secondSubsection = getCaseBodySubsection(4, 1);
    ...
    @Test
    public void comm_court_nyarugenge_2014_thirdSubsectionOfBodyHasExpectedHeading() {
        JsonObject thirdSubsection = getCaseBodySubsection(4, 2);
        assertTrue(thirdSubsection.hasKey("III.\tICYEMEZO CY\u2019URUKIKO"));
    }

    @Test
    public void comm_court_nyarugenge_2014_thirdSubsectionHasExpectedLength() {
        JsonObject thirdSubsection = getCaseBodySubsection(4, 2);
        JsonArray subsectionArray = thirdSubsection.getArrayByKey("III.\tICYEMEZO CY\u2019URUKIKO");
    ...
    @Test
    public void comm_court_nyarugenge_2014_thirdSubsectionMatchesExpectedContent() {
        JsonObject thirdSubsection = getCaseBodySubsection(4, 2);
        String actualSubsection = thirdSubsection.getArrayByKey("III.\tICYEMEZO CY\u2019URUKIKO").toString();
    ...
    @Test
    public void comm_court_nyarugenge_2016_BackgroundSectionHasExpectedLength() {
    ...
    @Test
    public void comm_court_nyarugenge_2016_secondSubsectionOfBodyHasExpectedHeading() {
        JsonObject secondSubsection = getCaseBodySubsection(5, 1);
        assertTrue(secondSubsection.hasKey("II.\tISESENGURA RY\u2018INZITIZI"));
    }

    @Test
    public void comm_court_nyarugenge_2016_secondSubsectionHasExpectedLength() {
        JsonObject secondSubsection = getCaseBodySubsection(5, 1);
    ...
    @Test
    public void comm_court_nyarugenge_2016_secondSubsectionMatchesExpectedContent() {
        JsonObject secondSubsection = getCaseBodySubsection(5, 1);
    ...
    @Test
    public void comm_court_nyarugenge_2016_thirdSubsectionOfBodyHasExpectedHeading() {
        JsonObject thirdSubsection = getCaseBodySubsection(5, 2);
        assertTrue(thirdSubsection.hasKey("III.\tICYEMEZO CY\u2019URUKIKO"));
    }

    @Test
    public void comm_court_nyarugenge_2016_thirdSubsectionHasExpectedLength() {
        JsonObject thirdSubsection = getCaseBodySubsection(5, 2);
        JsonArray subsectionArray = thirdSubsection.getArrayByKey("III.\tICYEMEZO CY\u2019URUKIKO");
        assertEquals(5, subsectionArray.getSize());
    }
    ...
    @Test
    public void comm_court_nyarugenge_2016_thirdSubsectionMatchesExpectedContent() {
        JsonObject thirdSubsection = getCaseBodySubsection(5, 2);
        String actualSubsection = thirdSubsection.getArrayByKey("III.\tICYEMEZO CY\u2019URUKIKO").toString();
    ...
    @Test
    public void comm_high_court_2016_BackgroundSectionHasExpectedLength() {
    ...
    @Test
    public void comm_high_court_2016_secondSubsectionHasExpectedHeading() {
        JsonObject caseBody = getCaseBodySubsection(6, 1);
        assertTrue(caseBody.hasKey("ISESENGURA RY\u2019IBIBAZO BIRI MU RUBANZA"));
    }

    @Test
    public void comm_high_court_2016_secondSubsectionHasExpectedLength() {
    ...
    @Test
    public void comm_high_court_2016_secondSubsectionMatchesExpectedContent() {
        JsonObject secondSubsection = getCaseBodySubsection(6, 1);
    ...
    @Test
    public void comm_high_court_2016_thirdSubsectionOfBodyHasExpectedHeading() {
        JsonObject thirdSubsection = getCaseBodySubsection(6, 2);
        assertTrue(thirdSubsection.hasKey("ICYEMEZO CY\u2019URUKIKO"));
    }

    @Test
    public void comm_high_court_2016_thirdSubsectionHasExpectedLength() {
        JsonObject thirdSubsection = getCaseBodySubsection(6, 2);
    ...
    @Test
    public void comm_high_court_2016_thirdSubsectionMatchesExpectedContent() {
        JsonObject thirdSubsection = getCaseBodySubsection(6, 2);
    ...
    @Test
    public void high_court_chamber_2014_secondSubsectionHasExpectedHeading() {
        JsonObject caseBody = getCaseBodySubsection(7, 1);
        assertTrue(caseBody.hasKey("II.\tISESENGURA RY\u2019IKIBAZO KIRI MU RUBANZA"));
    }

    @Test
    public void high_court_chamber_2014_secondSubsectionHasExpectedLength() {
    ...
    @Test
    public void high_court_chamber_2014_secondSubsectionMatchesExpectedContent() {
        JsonObject secondSubsection = getCaseBodySubsection(7, 1);
    ...
    @Test
    public void high_court_chamber_2014_thirdSubsectionOfBodyHasExpectedHeading() {
        JsonObject thirdSubsection = getCaseBodySubsection(7, 2);
        assertTrue(thirdSubsection.hasKey("III. ICYEMEZO CY\u2019URUKIKO"));
    }

    @Test
    public void high_court_chamber_2014_thirdSubsectionHasExpectedLength() {
        JsonObject thirdSubsection = getCaseBodySubsection(7, 2);
        JsonArray subsectionArray = thirdSubsection.getArrayByKey("III. ICYEMEZO CY\u2019URUKIKO");
    ...
    @Test
    public void high_court_chamber_2014_thirdSubsectionMatchesExpectedContent() {
        JsonObject thirdSubsection = getCaseBodySubsection(7, 2);
        String actualSubsection = thirdSubsection.getArrayByKey("III. ICYEMEZO CY\u2019URUKIKO").toString();
